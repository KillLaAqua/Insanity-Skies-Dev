...
//     [
//         'xycraft_world:shaped/aluminum_bricks_cloud_red',
//         'xycraft_world:shaped/aluminum_bricks_cloud_red_r',
//         'xycraft_world:shaped/aluminum_bricks_cloud_blue',
//         'xycraft_world:shaped/aluminum_bricks_cloud_blue_r',
//         'xycraft_world:shaped/aluminum_bricks_cloud_green',
//         'xycraft_world:shaped/aluminum_bricks_cloud_green_r',
//         'xycraft_world:shaped/aluminum_bricks_cloud_light',
//         'xycraft_world:shaped/aluminum_bricks_cloud_light_r',
//         'xycraft_world:shaped/aluminum_bricks_cloud_dark',
...
//     event.replaceInput(
//         { output: 'xycraft_world:glass_viewer_immortal' },
//         'gtceu:aluminium_ingot',
//         'gtceu:aluminium_nugget'
//     );
//     event.replaceInput(
//         { output: /xycraft_world:glass_viewer_phantom.*/ },
...
//     event
//         .shaped(Item.of('5x xycraft_world:aluminum_storage'), ['NCN', 'CNC', 'NCN'], {
...
//     event
//         .shaped(Item.of('2x xycraft_world:aluminum_bricks'), ['NC', 'CN'], {
//             N: 'gtceu:aluminium_nugget',
//             C: 'minecraft:calcite',
//         })
//         .id('start:shaped/aluminum_bricks');
//     event
//         .shaped(Item.of('4x xycraft_world:kivi'), ['BD', 'DB'], {
//             B: 'minecraft:basalt',
