    ...
    event
        ...
        .pattern((definition) =>
            FactoryBlockPattern.start()
                ...
                .where('P', Predicates.blocks('kubejs:high_steam_machine_casing')
        ...
        .workableCasingModel('kubejs:block/casings/basic/high_steam_machine_casing','kubejs:block/multiblock/primitive_blast_furnace')
        .editableUI(
            global.ui_builder({
                group: 'primitive',
                name: 'rugged_alloyer',
