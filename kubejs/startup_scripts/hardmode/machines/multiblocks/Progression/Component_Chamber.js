    ...
    event
        ...
        .pattern((definition) =>
            FactoryBlockPattern.start()
                ...
                .where(
                    'D',
                    Predicates.blocks('gtceu:frostproof_machine_casing')
        ...
        .workableCasingModel('gtceu:block/casings/solid/machine_casing_frost_proof', 'gtceu:block/machines/assembler');
});
