...
GTCEuStartupEvents.registry('gtceu:machine', (event) => {
    event
        .create('high_pressure_steam_sifter', 'multiblock')
        ...
        .workableCasingModel('kubejs:block/casings/basic/high_steam_machine_casing', 'gtceu:block/machines/sifter');
});
